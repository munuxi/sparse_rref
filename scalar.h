...
inline bool scalar_is_zero(fmpq_t a) {
	return fmpq_is_zero(a);
}

inline bool scalar_is_zero(ulong* a) {
	return (*a) == 0;
}

inline void scalar_set(fmpq_t a, const fmpq_t b) {
	fmpq_set(a, b);
}

inline void scalar_set(ulong* a, const ulong* b) {
	*a = *b;
}
